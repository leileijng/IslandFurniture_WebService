    ...
    <body>
        <script>
            ...
            function addLineItem() {
                document.lineItemManagement_Add.action = "../RecipeManagement_AddLineItemRecipeServlet";
            ...
            function removeLineItem() {
                ...
                if (checkboxes.length == 0 || numOfTicks == 0) {
                    ...
                    window.event.returnValue = true;
                    document.lineItemManagement.action = "../RecipeManagement_RemoveLineItemRecipeServlet";
                    document.lineItemManagement.submit();
                                ...
                                <div class="panel-heading"> 
                                    <%
                                        ...
                                        if (errMsg == null && goodMsg == null) {
                                            out.println("Add Recipe Line Item");
