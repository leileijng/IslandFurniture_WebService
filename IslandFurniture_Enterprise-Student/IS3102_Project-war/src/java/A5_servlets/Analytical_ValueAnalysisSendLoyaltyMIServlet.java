...
public class Analytical_ValueAnalysisSendLoyaltyMIServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (deleteArr != null && loyaltyPoints != 0) {
                ...
                response.sendRedirect("A5/rfmMenuItem.jsp?goodMsg=Successfully sent loyalty points : " + deleteArr.length + " record(s).");
            } else {
                response.sendRedirect("A5/rfmMenuItem.jsp?errMsg=Nothing is selected or no loyalty points enter.");
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
