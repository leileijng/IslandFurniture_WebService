...
public class ComboLineItemManagement_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (errMsg == null && goodMsg == null) {
                response.sendRedirect("A6/comboManagement_Update.jsp");
            } else if ((errMsg != null) && (goodMsg == null)) {
                if (!errMsg.equals("")) {
                    response.sendRedirect("A6/comboManagement_Update.jsp?errMsg=" + errMsg + "&id=" + comboId);
                }
            } else if ((errMsg == null && goodMsg != null)) {
                if (!goodMsg.equals("")) {
                    response.sendRedirect("A6/comboManagement_Update.jsp?goodMsg=" + goodMsg + "&id=" + comboId);
                }
            }
